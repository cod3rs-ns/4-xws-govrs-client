...
public class Subsection extends Element {
    ...
    public void validate(List<ErrorMessage> errorMessageList) {
        if (name.get() == null || "".equals(name.get()))
            errorMessageList.add(new ErrorMessage(id.get(), name.getName(), ElementType.Subsection, "Ime pododjeljka je obavezno."));
        if (getChildren().size() == 0)
            errorMessageList.add(new ErrorMessage(id.get(), name.getName(), ElementType.Paragraph, "Pododjeljak ne može biti prazan."));
